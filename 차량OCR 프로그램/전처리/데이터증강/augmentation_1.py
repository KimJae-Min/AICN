# 출처 https://github.com/qjadud1994/Korean-license-plate-Generator
import os, random
import cv2, argparse
import numpy as np
...
class ImageGenerator:
    def __init__(self, save_path):
        ...
        # Plate
        self.plate = cv2.imread("./images/src_plate_img/plate.jpg")
        self.plate2 = cv2.imread("./images/src_plate_img/plate_y.jpg")
        self.plate3 = cv2.imread("./images/src_plate_img/plate_g.jpg")

        # loading Number
        file_path = "./images/for_color_plate/num/"
        ...
        # loading Char
        file_path = "./images/for_color_plate/char1/"
        file_list = os.listdir(file_path)
        self.char_list = list()
        self.Char1 = list()
        for file in file_list:
        ...
        file_path = "./images/for_color_plate/num_y/"
        file_list = os.listdir(file_path)
        self.Number_y = list()
        ...
        # loading Char
        file_path = "./images/for_color_plate/char1_y/"
        file_list = os.listdir(file_path)
        ...
        # loading Resion
        file_path = "./images/for_color_plate/region_y/"
        file_list = os.listdir(file_path)
        self.Resion_y = list()
        ...
        file_path = "./images/for_color_plate/num_g/"
        file_list = os.listdir(file_path)
        self.Number_g = list()
        ...
        # loading Char
        file_path = "./images/for_color_plate/char1_g/"
        file_list = os.listdir(file_path)
        ...
        # loading Resion
        file_path = "./images/for_color_plate/region_g/"
        file_list = os.listdir(file_path)
        self.Resion_g = list()
...
parser.add_argument("-t", "--type", help="Plate type (1-5)", type=int, default=0)  # 추가된 부분
args = parser.parse_args()

img_dir = args.img_dir
num_img = args.num
Save = args.save
plate_type = args.type  # 타입 인자
